...
const cta = (audience, label) => `<a class="button dark" href="/contact?audience=${audience}">${label} ${arrow}</a>`;
...
if (path === '/gyms') {
  ...
  main.innerHTML = '<section class="contact-page"><div class="overline">404</div><h1>Let’s get you back.</h1><p>That page couldn’t be found.</p><a class="button dark" href="/">Back to home ↗</a></section>';
}
const active = document.querySelector(`[data-nav="${(path === '/' ? 'home' : path.slice(1))}"]`);
